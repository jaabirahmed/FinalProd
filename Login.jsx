...
export default class Login extends React.Component {
  ...
  handlePress = async () => {
    ...
    if (Object.keys(this.state.email).length == 0) {
      ...
      fetch('http://api.abc.com/api/Users/GetValidUserDetails', {
        method: 'POST',
        headers: {
        ...
        <KeyboardAvoidingView behavior="padding">
          <ScrollView keyboardShouldPersistTaps='handled'>
            ...
            <View style={styles.container}>
              ...
              <Text style={styles.subText}>A journey to <Text style={styles.titleText}>Sadaqah Jariyah,</Text>  begins from Home!</Text>
              ...
              <Text style={styles.subText}> New User? Submit your <Text style={styles.terms} onPress={this.openPrivacyPolicy.bind(this)}>onboarding request</Text></Text>
              ...
              <Text style={styles.subText}>Email: <Text style={styles.terms} onPress={this.openTermsCondition.bind(this)}>iqrarewards@gmail.com</Text></Text>
              </View>
            </View>
          </ScrollView>
